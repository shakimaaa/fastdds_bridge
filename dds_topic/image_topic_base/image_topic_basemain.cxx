        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<image_topic_baseApplication> app;
    ...
    else
    {
        try
        {
            app = image_topic_baseApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&image_topic_baseApplication::run, app);
