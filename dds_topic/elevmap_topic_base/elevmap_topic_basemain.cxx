...
/*!
 * @file elevmap_topic_basemain.cxx
        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<elevmap_topic_baseApplication> app;
    ...
    else
    {
        try
        {
            app = elevmap_topic_baseApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&elevmap_topic_baseApplication::run, app);
