        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<motor_state_16Application> app;
    ...
    else
    {
        try
        {
            app = motor_state_16Application::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&motor_state_16Application::run, app);
