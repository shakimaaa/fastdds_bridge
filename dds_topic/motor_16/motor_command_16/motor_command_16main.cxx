        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<motor_command_16Application> app;
    ...
    else
    {
        try
        {
            app = motor_command_16Application::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&motor_command_16Application::run, app);
