        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<imu_topic_baseApplication> app;
    ...
    else
    {
        try
        {
            app = imu_topic_baseApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&imu_topic_baseApplication::run, app);
